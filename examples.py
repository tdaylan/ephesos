...
def make_popl():
    ...
    pathimagpopl = pathbase + 'imag/Population/'
        ...
        for typetarg in listtypetarg:
            ...
            for name in listnamevarbtotl:
                if typesyst.startswith('psysdisk'): 
                    continue
                if typetarg != 'gene' and name != 'typebrgtcomp':
                    continue
            ...
            for namebatc in dictlistvalubatc.keys():
                ...
                strgextn = '%s_%s_%s' % (typesyst, typetarg, namebatc)
                ...
                if typesyst == 'psyspcur':
                    ...
                    strgextn = '%s_%s_%s_pcur' % (typesyst, typetarg, namebatc)
                    pathplot = ephesus.plot_lcur(pathimag, \
                                                 dictmodl=dictmodl, \
                                                 typefileplot=typefileplot, \
                                                 boolwritover=boolwritover, \
                    ...
                    strgextn = '%s_%s_%s_prim' % (typesyst, typetarg, namebatc)
                    ...
                    strgextn = '%s_%s_%s_seco' % (typesyst, typetarg, namebatc)
